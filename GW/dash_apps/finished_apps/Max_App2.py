...
app = DjangoDash('Max_App2')

app.layout = html.Div([

    html.H1("Average Maximum Temperature in Fahrenheit by Year", style={'text-align': 'center'}),
...
def update_graph(option_slctd2):
    ...
    data = [ dict( type='choropleth',
              ...
              colorbar = dict(title = "Avgerage Daily Max Air Temperature (F)"))]
